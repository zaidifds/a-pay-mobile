...
const BusinessAccountRegisteredAddressScreen: React.FC = () => {
  const navigation =
  ...
  const handleContinue = () => {
    if (validateForm()) {
      navigation.navigate('BusinessAccountPurpose');
    }
  };
      ...
      <View style={styles.contentContainer}>
        ...
        >
          ...
          >
            ...
            >
              {t('registered_address_description')}
            </Text>
...
export default BusinessAccountRegisteredAddressScreen;
