...
const SwapModalScreen: React.FC = () => {
  ...
  const { balances, prices } = useSelector((state: RootState) => state.wallet);
  ...
  const handleSwap = () => {
    ...
    Alert.alert(
      'Success',
      `Swapped ${amount} ${fromCurrency} to ${estimatedAmount} ${toCurrency}`,
    );
          ...
          <View style={styles.container}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.swapContainer}>
                ...
                <View
                  style={[styles.amountInput, styles.estimatedAmountContainer]}
                >
...
export default SwapModalScreen;
